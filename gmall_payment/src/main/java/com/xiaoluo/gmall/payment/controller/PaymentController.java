package com.xiaoluo.gmall.payment.controller;
...
import com.xiaoluo.gmall.enums.PaymentStatus;
import com.xiaoluo.gmall.myannotation.RequireLogin;
import com.xiaoluo.gmall.payment.config.AlipayConfig;
...
public class PaymentController {
	...
	public String index(String orderId, HttpServletRequest request){
		...
		UserInfo userInfo = userManagerService.getUserInfo(orderInfo.getUserId());
